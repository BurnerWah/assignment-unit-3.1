...
const favoriteFoods = ["pizza", "cookies", "egg rolls", "sushi"]
...
//      worked as expected.
const secondAnimal = animalArray[1]
...
const dessert = "brownies"
favoriteFoods.push(dessert)
console.log(`Added food ${dessert} to end of favorite foods: ${favoriteFoods}`)
...
const entree = "fried rice"
favoriteFoods.unshift(entree)
console.log(
  `Added food ${entree} to beginning of favorite foods: ${favoriteFoods}`
)
...
console.log(`Removed color ${lastColor} from end of colors: ${colors}`)
...
console.log(`Removed color ${firstColor} from start of colors: ${colors}`)
...
// .sort() will already put things in alphabetical order, so reversing it is reverse alphabetical order.
gems.sort().reverse()
console.log(`Gems ${gems}`)
...
// I don't think the ... operator is very fast but it's very simple to work with
